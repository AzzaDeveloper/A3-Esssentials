...
export function BoardTaskElement({
  ...
  return (
    ...
    >
      <div className="absolute -right-2 -top-3 z-20 flex items-center gap-1" data-drag-stop>
        <button
      ...
      <div
        className="absolute -bottom-2 -right-2 z-20 h-4 w-4 cursor-se-resize rounded-full border border-white bg-slate-900/80 shadow touch-none"
        data-drag-stop
        onPointerDown={(event) => {
          event.stopPropagation();
