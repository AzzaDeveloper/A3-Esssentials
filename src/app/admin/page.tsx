  ...
  return (
    <div className="min-h-screen bg-stone-950 text-white">
      ...
      <div className="max-w-3xl mx-auto p-6 space-y-6">
        ...
        <form action={action} className="space-y-4 bg-stone-900/60 border border-stone-700/50 rounded-lg p-4">
          ...
          <fieldset className="grid gap-2">
            ...
            <Textarea name="userIds" placeholder="UIDs separated by comma, space or newline" rows={3} />
          </fieldset>
